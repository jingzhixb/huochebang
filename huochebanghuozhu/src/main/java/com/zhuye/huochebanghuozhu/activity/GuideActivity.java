...
import com.zhuye.huochebanghuozhu.other.DepthPageTransformer;
import com.zhuye.huochebanghuozhu.other.TransformUtil;
...
//                    skip_Iv.setVisibility(View.VISIBLE);
    ...
    private static final int[] imagesArray = new int[]{
            R.drawable.h_viewpaper_1,
            R.drawable.h_viewpaper_2,
            R.drawable.h_viewpaper_3,
